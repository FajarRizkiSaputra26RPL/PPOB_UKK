...
<head>
  ...
  <title>AdminPPOB | Dashboard</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=base_url()?>index.php/Admin"><i class="fa fa-circle-o"></i>Data Admin</a></li>
            <li><a href="<?=base_url()?>index.php/Manager"><i class="fa fa-circle-o"></i>Data Manager</a></li>
          </ul>
        </li>
        ...
        <li class="">
         ...
         <li class="">
          <a href="#">
            <i class="fa fa-book"></i> <span>Generate Laporan</span>
          </a>
        </li>
